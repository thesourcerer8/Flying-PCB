...
/*
 * Revision History
 * 26 Mar 2013 v1.0.22 Changes from 1.0.12 are
 *                      1. Added revision history. 
 *                      2. Updated for Misra Checks
 *                      3. Removed the inclusion of types.h file
 *                      4. Updated to support XMC1000 devices.
 *                      5. Updated for the UTP MCSW300000618, for register
