...
public class usbd_lld_hw_privateh_template
{
  protected static String nl;
  public static synchronized usbd_lld_hw_privateh_template create(String lineSeparator)
  {
    nl = lineSeparator;
    usbd_lld_hw_privateh_template result = new usbd_lld_hw_privateh_template();
    nl = null;
    return result;
  }
