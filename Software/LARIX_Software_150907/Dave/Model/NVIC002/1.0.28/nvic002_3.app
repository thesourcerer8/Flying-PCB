...
3 is least priority equivalent to 192</toolTipHelpDescription>
  ...
  <provided xsi:type="ResourceModel:EnumerationParameter" name="Enable Interrupt" URI="http://www.infineon.com/1.0.28/app/nvic002/3/nvic002_erwenableint" multipleSelections="true">
    <defaultValue xsi:type="ResourceModel:IntegerValue" value="0"/>
    <localValue xsi:type="ResourceModel:StringValue" value="0"/>
    ...
    <item name="Enable interrupt at initialization" evalFunction="" URI="http://www.infineon.com/1.0.28/app/nvic002/3/nvic002_erwenableint/0" maxValue="1" minValue="0">
      <defaultValue xsi:type="ResourceModel:IntegerValue" value="0"/>
      <localValue xsi:type="ResourceModel:StringValue" value="1"/>
      <globalValue xsi:type="ResourceModel:StringValue" value="1"/>
  ...
  <provided xsi:type="ResourceModel:StringParameter" name="User defined interrupt handler" evalFunction="" URI="http://www.infineon.com/1.0.28/app/nvic002/3/nvic002_srwuserfunction">
    <defaultValue xsi:type="ResourceModel:StringValue" value=""/>
    <localValue xsi:type="ResourceModel:StringValue" value="BT_RECEIVE_ISR"/>
    <globalValue xsi:type="ResourceModel:StringValue" value="BT_RECEIVE_ISR"/>
    <toolTipHelpDescription>To define function as void MyInterrupt(void), type MyInterrupt in field.</toolTipHelpDescription>
  </provided>
  <provided xsi:type="ResourceModel:API" description="Function to configure the interrupts for all app instances&#xD;&#xA;&#x9;&#x9;&#x9;&#x9;             base on user configuration" URI="http://www.infineon.com/1.0.28/app/nvic002/3/nvic002_init" APIName="NVIC002_Init">
    <localValue xsi:type="ResourceModel:StringValue" value="-1"/>
    <globalValue xsi:type="ResourceModel:StringValue" value="-1"/>
  </provided>
  <provided xsi:type="ResourceModel:API" description="Function to enable the IRQ" URI="http://www.infineon.com/1.0.28/app/nvic002/3/nvic002_enableirq" APIName="NVIC002_EnableIRQ">
    <localValue xsi:type="ResourceModel:StringValue" value="-1"/>
    <globalValue xsi:type="ResourceModel:StringValue" value="-1"/>
  </provided>
  <provided xsi:type="ResourceModel:API" description="Function to disable the IRQ" URI="http://www.infineon.com/1.0.28/app/nvic002/3/nvic002_disableirq" APIName="NVIC002_DisableIRQ">
    <localValue xsi:type="ResourceModel:StringValue" value="-1"/>
    <globalValue xsi:type="ResourceModel:StringValue" value="-1"/>
  </provided>
  <consumed xsi:type="ResourceModel:ProxyResource" URI="http://www.infineon.com/1.0.28/app/nvic002/3/nvicnode">
  ...
  <consumed xsi:type="ResourceModel:ProxyResource" URI="http://www.infineon.com/1.0.28/app/nvic002/3/nvicnode/signal_in" isSystemDefined="true">
    <downWardmappedList xsi:type="ResourceModel:SignalDeclaration" href="../../CPU/CPU_0.dd#//@provided.10"/>
  </consumed>
  <consumed xsi:type="ResourceModel:ProxyResource" URI="http://www.infineon.com/1.0.28/app/nvic002/3/nvicnode/ipr_pri" upWardMappingList="//@provided.1 //@provided.3" isSystemDefined="true">
    <localValue xsi:type="ResourceModel:IntegerValue" value="4c"/>
    <downWardmappedList xsi:type="ResourceModel:BitField" href="../../CPU/CPU_0.dd#//@provided.11"/>
    <globalValue xsi:type="ResourceModel:IntegerValue" value="4c"/>
  </consumed>
