...
3 is least priority equivalent to 192</toolTipHelpDescription>
  ...
  <provided xsi:type="ResourceModel:StringParameter" name="User defined interrupt handler" evalFunction="" URI="http://www.infineon.com/1.0.28/app/nvic002/7/nvic002_srwuserfunction">
    ...
    <localValue xsi:type="ResourceModel:StringValue" value="Monitoring_TIMER_ISR"/>
    <globalValue xsi:type="ResourceModel:StringValue" value="Monitoring_TIMER_ISR"/>
