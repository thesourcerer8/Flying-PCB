...
3 is least priority equivalent to 192</toolTipHelpDescription>
  ...
  <provided xsi:type="ResourceModel:StringParameter" name="User defined interrupt handler" evalFunction="" URI="http://www.infineon.com/1.0.28/app/nvic002/10/nvic002_srwuserfunction">
    ...
    <localValue xsi:type="ResourceModel:StringValue" value="ESC_UART_RX_ISR"/>
    <globalValue xsi:type="ResourceModel:StringValue" value="ESC_UART_RX_ISR"/>
