/*!
* \file             GPIO.h
* Project           PrjORIGADemo
* \profile          hardware
* \description      This file holds the basic defines for the
* 					GPIO usage
*
**********************************************************
* \author			gn
...
// Control_P0_1(mode, drive strength); where the mode is INPUT, INPUT_PD ...
// OUTPUT_PP_GP ... OUTPUT_ODAF4. (see definitions below)
// and drive-strength is WEAK, MEDIUM, STRONG or VERYSTRONG
//
...
//Port 14
//
#define SET_P14_4       PORT14->OMR = 0x00000010
#define SET_P14_5       PORT14->OMR = 0x00000020
#define SET_P14_8       PORT14->OMR = 0x00000100
#define SET_P14_9       PORT14->OMR = 0x00000200

#define RESET_P14_4       PORT14->OMR = 0x00100000
#define RESET_P14_5       PORT14->OMR = 0x00200000
#define RESET_P14_8       PORT14->OMR = 0x01000000
#define RESET_P14_9       PORT14->OMR = 0x02000000

#define TOGGLE_P14_4       PORT14->OMR = 0x00100010
#define TOGGLE_P14_5       PORT14->OMR = 0x00200020
#define TOGGLE_P14_8       PORT14->OMR = 0x01000100
#define TOGGLE_P14_9       PORT14->OMR = 0x02000200

#define Control_P14_4(Mode)       PORT14->IOCR4 = (PORT14->IOCR4 & ~0x000000F8) | (Mode << 3);
#define Control_P14_5(Mode)       PORT14->IOCR4 = (PORT14->IOCR4 & ~0x0000F800) | (Mode << 11);
#define Control_P14_8(Mode)       PORT14->IOCR8 = (PORT14->IOCR8 & ~0x000000F8) | (Mode << 3);
#define Control_P14_9(Mode)       PORT14->IOCR8 = (PORT14->IOCR8 & ~0x0000F800) | (Mode << 11);

//********************************************
//Port 15
//
#define SET_P15_8       PORT15->OMR = 0x00000100
#define SET_P15_9       PORT15->OMR = 0x00000200

#define RESET_P15_8       PORT15->OMR = 0x01000000
#define RESET_P15_9       PORT15->OMR = 0x02000000

#define TOGGLE_P15_8       PORT15->OMR = 0x01000100
#define TOGGLE_P15_9       PORT15->OMR = 0x02000200

#define Control_P15_8(Mode)       PORT15->IOCR8 = (PORT15->IOCR8 & ~0x000000F8) | (Mode << 3);
#define Control_P15_9(Mode)       PORT15->IOCR8 = (PORT15->IOCR8 & ~0x0000F800) | (Mode << 11);
